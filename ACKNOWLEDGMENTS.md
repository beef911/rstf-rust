...
- **The RustCrypto Team**: For their implementation of the Argon2 and ChaCha20Poly1305 crates.
- **Zstandard (Zstd)**: For the high-performance compression engine.
- **Anyhow, Clap, and Indicatif**: For providing the essential building blocks for error handling, CLI parsing, and terminal feedback.
