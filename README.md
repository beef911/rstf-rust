<div align="center">
  ...
  [![Release](https://img.shields.io/github/v/release/beefcon/rstf-rust)](https://github.com/beefcon/rstf-rust/releases)
  [![License](https://img.shields.io/badge/license-MIT-blue.svg)](LICENSE)
  [![Platform](https://img.shields.io/badge/platform-Win%20%7C%20Linux%20%7C%20Mac%20%7C%20Android-green)](https://github.com/beefcon/rstf-rust/releases)
  [![GitHub Stars](https://img.shields.io/github/stars/beefcon/rstf-rust?style=social)](https://github.com/beefcon/rstf-rust)
...
```bash
wget https://github.com/beefcon/rstf-rust/releases/latest/download/rstf-android-arm64 -O $PREFIX/bin/rstf
```
...
```bash
wget https://github.com/beefcon/rstf-rust/releases/latest/download/rstf-android-x86_64 -O $PREFIX/bin/rstf
```
...
```bash
sudo wget https://github.com/beefcon/rstf-rust/releases/latest/download/rstf-linux-amd64 -O /usr/local/bin/rstf
```
...
```bash
sudo wget https://github.com/beefcon/rstf-rust/releases/latest/download/rstf-linux-arm64 -O /usr/local/bin/rstf
```
...
```bash
sudo wget https://github.com/beefcon/rstf-rust/releases/latest/download/rstf-linux-amd64-musl -O /usr/local/bin/rstf
```
...
```bash
sudo wget https://github.com/beefcon/rstf-rust/releases/latest/download/rstf-macos-amd64 -O /usr/local/bin/rstf
```
...
```bash
sudo wget https://github.com/beefcon/rstf-rust/releases/latest/download/rstf-macos-arm64 -O /usr/local/bin/rstf
```
...
### Windows Users
1. Download the appropriate .exe from the [Release Page](https://github.com/beefcon/rstf-rust/releases) (MSVC recommended for compatibility, GNU as alternative).
...
### Ways to Contribute
* **Report Issues:** Found a bug or have a feature request? Open an [issue](https://github.com/beefcon/rstf-rust/issues) on GitHub.
...
```bash
git clone https://github.com/beefcon/rstf-rust.git
```
